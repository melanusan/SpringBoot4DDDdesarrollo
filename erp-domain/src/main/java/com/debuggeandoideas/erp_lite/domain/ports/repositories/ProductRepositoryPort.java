...
/**
 * Port (interface) for product persistence operations / Puerto para operaciones de persistencia de productos.
 *
 * English: This is a domain port that defines persistence operations the application expects.
 * Español: Es un puerto del dominio que define las operaciones de persistencia que la aplicación espera.
 *
 * Implementations (adapters) live in the infrastructure layer (e.g., JPA, Mongo, remote HTTP).
 *
